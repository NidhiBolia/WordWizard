    ...
    <Link href={href} aria-disabled={locked} style={{pointerEvents:locked?"none":"auto"}}>
        ...
        {current?(
            <div className="h-[102px] w-[102px] relative">
                ...
                font-bold uppercase text-sky-500 bg-white rounded-xl animate-bounce tracking-wide z-10
                ">
                    Start
                ...
                >
                <Button size="rounded" variant={locked?"locked":"primary"} className="h-[70px] w-[70px] border-b-8">
                    <Icon  className={cn("h-10 w-10 ",locked?"fill-neutral-400 text-neitral-400 stroke-neutral-400":
